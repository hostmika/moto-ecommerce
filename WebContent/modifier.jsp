		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<!-- Order Details -->
					<div class="col-md-5 order-details" style="margin-left:325px;">
						...
						<form action="modification" method="POST" >
							...
							<select class="input-select" name="marque">
								...
								<div class="input-radio">
									<input type="radio" name="type" value="2T" id="payment-1">
									<label for="payment-1">
										<span></span>
										2T
									</label>
								...
								<div class="order-notes">
									<textarea class="input" name="fiche" placeholder="Fiche"></textarea>
								</div>
								<div class="form-group">
